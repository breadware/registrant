...
public class GcpConfiguration {
    ...
    public static final List<String> SCOPES = List.of(GmailScopes.GMAIL_READONLY, SheetsScopes.SPREADSHEETS);
    ...
    public HttpRequestInitializer createCredentials(HttpRequestInitializerCreator httpRequestInitializerCreator) {
        LOGGER.info("Using \"{}\" class as HTTP request initializer creator.", httpRequestInitializerCreator.getClass().getName());
        return httpRequestInitializerCreator.create();
    }

    @Bean(BeanNames.GMAIL)
    public Gmail createGmail(NetHttpTransport netHttpTransport, JsonFactory jsonFactory, HttpRequestInitializer httpRequestInitializer) {
    ...
    public Sheets createSheets(NetHttpTransport netHttpTransport, JsonFactory jsonFactory, HttpRequestInitializer httpRequestInitializer) {
