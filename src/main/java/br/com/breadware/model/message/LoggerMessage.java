...
public enum LoggerMessage implements Message {
    ...
    SKIPPING_GOOGLE_CREDENTIALS_ENVIRONMENT_VARIABLE_CHECK(12),
    EXCLUDING_EXPIRED_HANDLED_GMAIL_MESSAGES(13),
    NO_EXPIRED_HANDLED_GMAIL_MESSAGE_TO_EXCLUDE(14),
    EXPIRED_HANDLED_GMAIL_MESSAGES_EXCLUDED(15);
